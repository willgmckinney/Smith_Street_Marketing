...
/**
 * High-level architecture of Apollo Mapping's ImageHunter: a multi-repo
 * satellite-imagery search-and-order system. A React SPA talks to a Flask
 * backend over /ajax (JWT); the backend queries a PostGIS imagery catalog and
 * live vendor APIs. A Celery pipeline ingests scenes and renders previews to
 * S3, and a newer FastAPI service exposes the catalog to partners.
 */
export const ImageHunterDiagram = ({
  className = "",
}: ImageHunterDiagramProps) => (
  <svg
    viewBox="0 0 680 614"
    fill="none"
    className={className}
  ...
  >
    ...
    {/* client -> flask */}
    <line x1="340" y1="74" x2="340" y2="118" className={linkCls} markerEnd="url(#ih-arrow)" />
    {/* flask -> branch (postgis + vendors) */}
    <polyline points="340,180 340,206 130,206 130,248" className={linkCls} fill="none" markerEnd="url(#ih-arrow)" />
    <polyline points="340,180 340,206 552,206 552,238" className={linkCls} fill="none" markerEnd="url(#ih-arrow)" />
    {/* postgis <-> vendors (live availability) */}
    <line x1="232" y1="278" x2="450" y2="278" className={dashCls} markerStart="url(#ih-arrow)" markerEnd="url(#ih-arrow)" />
    {/* update -> postgis (ingest) */}
    <line x1="130" y1="398" x2="130" y2="312" className={linkCls} markerEnd="url(#ih-arrow)" />
    {/* update -> s3 (render/cache) */}
    <line x1="234" y1="430" x2="298" y2="430" className={linkCls} markerEnd="url(#ih-arrow)" />
    {/* public-api read access to catalog, routed along the left margin */}
    <polyline points="190,548 14,548 14,278 26,278" className={dashCls} fill="none" markerEnd="url(#ih-arrow)" />
