          ...
          <div className="bg-drafting-surface rounded-card p-8 border border-chalk/10 border border-chalk/10">
            <div className="mb-8">
              ...
              <div className="relative">
                <span className="absolute left-4 top-1/2 -translate-y-1/2 text-marker-start font-bold text-xl">
                  $
                </span>
                <input
                  id="revenue"
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <div className="bg-drafting-surface/50 rounded-lg p-6 border border-red-500/20">
              ...
              <div className="bg-drafting-surface/50 rounded-lg p-6 border border-verified/30">
                <div className="flex items-center justify-between mb-2">
                  <h3 className="text-verified font-semibold text-sm uppercase tracking-wider">
                    Custom Stack (Owner)
                  </h3>
                </div>
                <div className="text-3xl font-bold text-verified mb-1">
              ...
              <tbody>
                <tr className="border-b border-chalk/10">
                  ...
                  <td className="p-4 text-red-400">
                    ...
                    <div className="text-sm text-chalk/60">+ 0.20% gateway fee (if not using Shopify Payments)</div>
                  </td>
                  <td className="p-4 text-verified">
                    <div>Interchange + 10-20bps (~1.8% effective)</div>
                    <div className="text-sm text-chalk/60 mt-1">Fixed hosting costs</div>
                ...
                <tr className="border-b border-chalk/10">
                  ...
                  <td className="p-4 text-red-400">
                    ...
                    <div className="text-sm text-chalk/60">Loyalty: $300-$1,500/mo</div>
                    <div className="text-sm text-chalk/60">Subscriptions: $500+/mo</div>
                  </td>
                  <td className="p-4 text-verified">
                    <div>&lt;$5,000 annually</div>
                    <div className="text-sm text-chalk/60 mt-1">Built into code (owned forever)</div>
                ...
                <tr className="border-b border-chalk/10">
                  ...
                  <td className="p-4 text-red-400">
                    ...
                    <div className="text-sm text-chalk/60">Every 100ms delay = 7% conversion drop</div>
                  </td>
                  <td className="p-4 text-verified">
                    <div>&lt; 1.0s (sub-second)</div>
                    <div className="text-sm text-chalk/60 mt-1">Built for speed from day one</div>
                ...
                <tr className="border-b border-chalk/10">
                  ...
                  <td className="p-4 text-red-400">
                    ...
                    <div className="text-sm text-chalk/60">TOS volatility (category shutdowns)</div>
                    <div className="text-sm text-chalk/60">Data ownership limitations</div>
                  </td>
                  <td className="p-4 text-verified">
                    <div>Total ownership</div>
                    <div className="text-sm text-chalk/60 mt-1">No platform dependencies</div>
                    <div className="text-sm text-chalk/60">Full data control</div>
                    <div className="text-sm text-chalk/60">Risk-free infrastructure</div>
                  </td>
                </tr>
                <tr>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-blueprint-base">
        <div className="max-w-4xl mx-auto">
          <div className="bg-marker-start/20 border-2 border-marker-start rounded-card p-12 text-center">
            ...
            <p className="text-lg text-chalk/80 mb-8 max-w-2xl mx-auto">
