...
export const timelineContent: Record<ServiceType, TimelineMilestone[]> = {
  ...
  software: [
    ...
    },
    {
      ...
      icon: "layers",
      description:
        "See your product before we build it. We deliver clickable prototypes and labeled architecture diagrams that validate user flows and technical feasibility. Our designs aren't just pretty, they're informed by scalability requirements, security constraints, and cost optimization from day one.",
      metrics: [
    ...
    },
    {
      ...
      icon: "chart",
      description:
        "Launch day should be boring, and with us, it is. Blue-green deployments on AWS with automatic rollback mean zero-downtime releases. Monitoring on every service catches performance degradation before users notice. We've launched products that handled 10x traffic spikes without breaking a sweat.",
      metrics: [
  ...
  aws: [
    {
      ...
      icon: "compass",
      description:
        "Cloud migrations fail when the business case isn't solid. We conduct full infrastructure audits, dependency mapping, and TCO analysis that proves the ROI. You'll know exactly what you're getting into: timeline, risks, costs, and benefits, all quantified.",
      metrics: [
    ...
    },
    {
      ...
      icon: "brain",
      description:
        "Our phased migration approach means your business never stops. We migrate workloads incrementally with tested rollback plans at every step. Automated testing validates functionality in the cloud before we cut over. Zero data loss isn't a goal, it's a guarantee.",
      metrics: [
