...
const recentBuilds = ["Apollo Mapping", "Ascent Pharmaceuticals", "Airbus"];
...
export const HeroBanner = () => {
  return (
    <div className="relative flex flex-col items-center justify-center h-screen w-full overflow-hidden bg-blueprint-base">
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-blueprint-base/90 via-transparent to-transparent pointer-events-none" />
